...
using OopLecture.Data;
using OopLecture.Data.Abstractions;
using OopLecture.Data.Enums;
using OopLecture.Data.Models;
using OopLecture.Data.Services;
using OopLecture.Domain.Helpers;

namespace OopLecture.Presentation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var soloConcert = new EventSoloConcert
            {
